                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-box me-2"></i>Contables</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('contable.create',['role' => 'contable']) }}" class="dropdown-item">Ajouter Contable</a>
                            <a href="{{ route('contable.index') }}" class="dropdown-item">Liste Contable</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="{{ route('indexClient') }}" class="nav-link"><i
                                class="fa fa-tags me-2"></i>Clients</a>
                    </div>
                </div>
            </nav>
        </div>
